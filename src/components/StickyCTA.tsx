      ...
      <div className="relative container-x py-3 md:py-3.5">
        <div className="flex gap-2.5 md:gap-3 max-w-[760px] mx-auto">
          ...
          <a
            ...
            className="relative flex-1 flex items-center justify-center gap-1.5 md:gap-2 py-3.5 md:py-4 rounded-xl md:rounded-2xl text-[13px] md:text-[15px] font-bold text-white whitespace-nowrap bg-gradient-to-br from-[#37AEE2] to-[#1E96C8] shadow-[0_8px_24px_rgba(34,158,217,0.35)] hover:brightness-[1.05] active:scale-[0.98] transition-all overflow-hidden"
          >
